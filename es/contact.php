<?php
	...
	$thanksPage = 'http://www.greenjobworks.com/es/thanks.php'; // URL to 'thanks for sending mail' page; leave empty to keep message on the same page 
...
<head>
	...
	<meta property="og:url" content="http://greenjobworks.com/es/contact.php">
